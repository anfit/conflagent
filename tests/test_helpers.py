...
from conflagent import resolve_or_create_path, update_page

@patch("conflagent.CONFIG", {"gpt_shared_secret": "secret", "root_page_id": "root", "space_key": "SPACE", "base_url": "http://example.com", "email": "a", "api_token": "b"})
...
def test_resolve_or_create_path(mock_post, mock_headers, mock_get_title):
    ...
    # simulate two levels: existing "Level1", missing "Level2"
